"""Replay motion from CSV file and output to npz file for HU_D03_03."""
...
sys.path.insert(0, str(_ROOT.parent / "mjlab" / "mjlab-main"))
...
def main(
  ...
  # Load the environment config for HU_D03_03 mimic flat environment
  scene = Scene(hu_d03_mimic_flat_env_cfg().scene, device=device)
  
  # Actuated joint names for HU_D03_03 (31 DOF) in order
  joint_names = [
